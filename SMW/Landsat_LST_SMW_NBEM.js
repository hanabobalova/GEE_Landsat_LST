...
Changed path to the js file with functions for calculating surface emissivity.
...
INPUTS:
        ...
        - use_ndvi: <number>
                ...
                if 2, emissivity is calculated by the NDVI-based method.
OUTPUTS:
        - <ee.ImageCollection>
...
//surface emissivity
var EM = require('users/hanele/LST:SMW/compute_emissivity_NBEM.js')
...
exports.collection = function(landsat, date_start, date_end, geometry, use_ndvi) {
  ...
  print('! Coefficients for Landsat-9 are now available !')
